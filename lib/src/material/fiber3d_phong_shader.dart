...
$resolved""";
  ...
  static String fragment(
    ...
    // Same duplicate-varying handling as Fiber3DLambertShader — the
    // fragment body declares vViewPosition itself, so the chunk's own
    // copy of that line must be stripped before inclusion, not the
    // ported chunk file edited.
    final phongParsWithoutDuplicateVarying = fiber3dLightsPhongParsFragment
...
$phongParsWithoutDuplicateVarying
